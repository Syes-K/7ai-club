...
本文档承接 [`iterations/0.0.8/product/prd-console-pro-layout-mix.md`](../../iterations/0.0.8/product/prd-console-pro-layout-mix.md)（同步本文档至 [`docs/product/prd-console-pro-layout-mix.md`](../product/prd-console-pro-layout-mix.md)），供 **frontend** 实现与验收对照；**本迭代无新增 API**，服务端阶段仅需确认无变更。
